                        ...
                        <div class="flex flex-wrap -mx-6">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <div class="mb-4">
                                        <div id="fileLabel" class="text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 focus:outline-none">
                                            <label for="fileInput" style="padding: 2px 7px; background-color: #dadada; cursor: pointer; border: 1px solid #767676; color: black; font-size: 14px;" class="text-size-sm">Choose File</label>
                                            <span><a href="{{ asset('storage/images/' . $pelatihan->gambar_pelatihan) }}" target="_blank" class="text-size-sm">
                                                    {{$pelatihan->gambar_pelatihan}}
                                                </a></span>
                                        </div>
                                        <input onchange="hideFileInput()" id="fileInput" type="file" class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" style="display: none;" name="gambarrr">
                                    </div>
                                </div>
                            </div>
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
