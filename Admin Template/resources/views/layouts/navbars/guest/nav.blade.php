    <nav
        ...
        <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
            ...
            {{ Request::is('static-sign-up') || Request::is('register') ? 'text-white' : 'text-slate-700' }}"
                href="{{ url('dashboard') }}">  <img src="../assets/img/logo_profile.png" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
            DTP-TKP</a>
