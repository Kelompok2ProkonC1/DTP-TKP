                        ...
                        <div class="flex flex-wrap -mx-6">
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <div class="mb-4">
                                        <input type="text" class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Masukkan NIK User..." name="nik" aria-label="NIK" aria-describedby="nik-addon" maxlength="16" minlength="16" required title="must 16 digit numbers" value="{{ $user->nik_user }}" readonly/>
                                        @error('nik')
                                        {{-- <p class="text-size-sm text-red-500">{{ $message }}</p> --}}
                                        @enderror
                                    </div>
