                ...
                <div class="flex-auto p-4">
                    ...
                    <form wire:submit.prevent="add_category">
                        <div class="-mx-6 px-3">
                            ...
                            <div class="mb-4">
                                <textarea wire:model.lazy="deskripsi_kategori" rows="4" class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Masukkan deskripsi kategori..." id="user-about">  </textarea>
