                    ...
                    <div class="flex flex-wrap -mx-6">
                        <div class="max-w-full px-3 w-1/2 lg:flex-none">
                            <div class="mt-3 rounded-t-2xl">
                                <h5 class="dark:text-white"><b>Update Category</b></h5>
                                <p>Update data of specific category!</p>
                            </div>
                        </div>
                        <div class="max-w-full px-3 w-1/2 lg:flex-none">
                            <div class="mx-6">
                    ...
                    <form action="{{ route('updating-category') }}" method="POST">
                        ...
                        <div class="-mx-6 px-3">
                            ...
                            <input type="hidden" name="id" value="{{ $category->id }}">
                                <input type="text" class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Masukkan nama kategori..." name="nama_kategori" aria-label="Nama Kategori" aria-describedby="nama_kategori-addon" required minlength="3" autofocus value="{{ $category->nama_kategori }}"/>
                            ...
                            <div class="mb-4">
                                <textarea rows="4" class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Masukkan deskripsi kategori..." id="user-about" name="deskripsi_kategori" maxlength="256" minlength="3" required>{{ $category->deskripsi_kategori }}</textarea>
